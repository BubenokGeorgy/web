...
const apiKey = "590b7ffd-0b6d-45f0-bf90-937c5e7c1b16";
let allData;
...
function clickOnEye(event) {                                    
    ...
    option1.value = "Быстрый выезд гида (30% увеличение стоимости)";
...
function clickOnPen(event) {                           
    ...
    switchLabel1.textContent = "Использовать услугу быстрого выезда гида";
    let routeOptionF = event.target.parentNode.parentNode.getAttribute("data-option1");
